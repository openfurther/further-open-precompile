/*******************************************************************************
 * Source File: UuedwIdTranslator.java
 ******************************************************************************/
...
/**
 * Translates DW ids to a federated identifier.
 * 
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 */
@Implementation
@Service("omrsIdTranslator")
@Transactional(value = "lookupTransactionManager")
public final class OmrsIdTranslator implements IdTranslationProvider
{
	...
	private static final Logger log = getLogger(OmrsIdTranslator.class);
